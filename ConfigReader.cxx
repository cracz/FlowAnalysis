...
{
  const TString intValKeys[5] = {"epd_max_weight", "nHits", "dEdx", "min_tracks", "shift_terms"};
  const TString doubleValKeys[13] = {"order_n", "order_m", "epd_threshold", "tracking", "dca", "min_abs_tpc_eta", "near_abs_tpc_eta", 
				     "far_abs_tpc_eta", "max_abs_tpc_eta", "r_vtx", "z_vtx_low", "z_vtx_high", "y_mid"};
